...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/Flipper/Flipper.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Flipper-DoubleConversion/DoubleConversion.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Flipper-Folly/folly.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Flipper-Glog/glog.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Flipper-PeerTalk/peertalk.framework"
